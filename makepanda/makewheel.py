...
# Plug-ins to install.
PLUGIN_LIBS = ["pandagl", "pandagles", "pandagles2", "pandadx9", "p3tinydisplay", "p3ptloader", "p3assimp", "p3ffmpeg", "p3openal_audio", "p3fmod_audio", "p3fmod_studio_audio", "p3headlessgl"]
...
def makewheel(version, output_dir, platform=None):
    ...
    if is_windows:
        ...
        # Use sys.base_prefix to find DLL in base Python installation (works with venv)
        pylib_path = os.path.join(sys.base_prefix, pylib_name)
    elif is_macosx:
