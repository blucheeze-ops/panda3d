...
#ifdef BUILDING_FMOD_STUDIO_AUDIO
  #define EXPCL_FMOD_STUDIO_AUDIO EXPORT_CLASS
  #define EXPTP_FMOD_STUDIO_AUDIO EXPORT_TEMPL
#else
  #define EXPCL_FMOD_STUDIO_AUDIO IMPORT_CLASS
  #define EXPTP_FMOD_STUDIO_AUDIO IMPORT_TEMPL
#endif
